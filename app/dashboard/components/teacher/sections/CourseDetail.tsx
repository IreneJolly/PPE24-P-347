...
export default function CourseDetail({
  ...
  const getTabClasses = (tabName: TabName) => {
    const baseClasses =
      "px-4 py-2 text-sm font-medium rounded-t-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 border-b-2"; // Added border-b
            ...
            {courseMaterials.length > 0 ? (
              courseMaterials.map((material) => (
                ...
                >
                  <div
                    key={material.id}
                    className="flex items-center justify-between p-3 border rounded-lg text-sm bg-white hover:bg-gray-50 shadow-sm"
                  >
                    <div>
                      {material.title}
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0 ml-4">
                      ...
                      <div className="flex space-x-1">
                        <button
                          ...
                          className="p-1 text-blue-600 hover:text-blue-800 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
                          title="Edit material"
                        >
                          <EditIcon />
                        </button>
                        <button
                          ...
                          className="p-1 text-red-600 hover:text-red-800 rounded focus:outline-none focus:ring-1 focus:ring-red-500"
        ...
        <div className="border-b border-gray-200">
          ...
          >
            ...
            <button
              ...
              className={getTabClasses("materials")}
            >
              Materials
            </button>
            <button
              onClick={() => setActiveTab("competences")}
              className={getTabClasses("competences")}
            >
              Competences
            </button>
            <button
              onClick={() => setActiveTab("assignments")}
              className={getTabClasses("assignments")}
            >
              Assignments
            </button>
            <button
              onClick={() => setActiveTab("students")}
              className={getTabClasses("students")}
            >
